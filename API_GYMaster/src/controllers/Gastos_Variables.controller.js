...
export const insertar = async (req,res) => {
    ...
    try {
        ...
        .query(queries.Gastos_Variables.Insertar)
...
export const modificar = async (req, res) => {
    ...
    const {Id_Gym,Id_Moneda,Nombre,Monto} = req.body
    const val = ValidarDatos([Id_Gym,Id_Moneda,Nombre,Monto]);
    if(val != 'todo bien'){
    ...
    try {
        ...
        .query(queries.Gastos_Variables.Modificar)
